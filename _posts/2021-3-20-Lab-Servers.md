...
そこで`nvidia-smi`を`nvidia-smi | grep -v Xorg`で置き換えることで、Xorgを消すことに成功しました（）。
...
幸いにも簡単な工事で系統を増やすことができましたが、今後更にノードが増えるとどうなることやら。。。
...
私はニコニコ話をしましたが、基本オンラインで行ったため他の人たちが談笑していたかは...どうでしょう。  
